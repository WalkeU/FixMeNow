...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $query = "SELECT id, title, created_at, report_status, priority FROM reports WHERE report_status != 'archivált'"; 
            ...
            <div class="table-wrapper">
                ...
                <table id="taskTable">
                        ...
                        <form method="POST" action="">
                            <div class="filters">
                                <select name="status" id="status" class="status-dropdown" onchange="this.form.submit()">
                                    ...
                                    <option value="Nyitott" <?= $selected_status == 'Nyitott' ? 'selected' : '' ?>>Nyitott</option>
                                    ...
                                    <option value="Beszerzés alatt" <?= $selected_status == 'Beszerzés alatt' ? 'selected' : '' ?>>Beszerzés alatt</option>
                    ...
                    <?php if (empty($results_assigned)) : ?>
                        <tr>
                            <td colspan="5">Nincs feladat!</td>
                        </tr>
                    <?php else : ?>
                        <?php foreach ($results_assigned as $row) : ?>
                            <tr onclick="location.href='details.php?id=<?= $row['id'] ?>'">
