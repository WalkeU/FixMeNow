...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $query = "SELECT id, title, created_at, report_status, priority FROM reports WHERE report_status = 'Nyitott'"; 
            ...
            <div class="table-wrapper">
                ...
                <table id="taskTable">
                    ...
                    <?php if (empty($results_assigned)) : ?>
                        <tr>
                            <td colspan="4">Nincs új feladat!</td>
                        </tr>
                    <?php else : ?>
